...
The adapter's static Chrome shortcut defaults are explicitly tied to this fixture version and tested. Resolving equivalent visible menu items dynamically before falling back to those defaults remains follow-up work.
